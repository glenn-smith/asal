...
class WYPath
{
	...
	function sMakeFilename($s)
	{
      ...
      if (!isset($WYPath_dISOToFilename)) $WYPath_dISOToFilename = array("Ä" => "Ae", "Ö" => "Oe", "Ü" => "Ue", "ä" => "ae", "ö" => "oe", "ü" => "ue", "ß" => "ss", " " => "_", "'" => "_", "/" => "_", "\\" => "_", "." => "_", ":" => "_");
      if (!isset($WYPath_dUTF8ToFilename)) $WYPath_dUTF8ToFilename = array(utf8_encode("Ä") => "Ae", utf8_encode("Ö") => "Oe", utf8_encode("Ü") => "Ue", utf8_encode("ä") => "ae", utf8_encode("ö") => "oe", utf8_encode("ü") => "ue", utf8_encode("ß") => "ss", " " => "_", "'" => "_", "/" => "_", "\\" => "_", "." => "_", ":" => "_");
