...
<script language="JavaScript" type="text/javascript" src="../opt/rte/html2xhtml.js"></script>
<script language="JavaScript" type="text/javascript" src="../opt/rte/richtext_compressed.js"></script>
...
<!--
   ...
   initRTE("../opt/rte/images/", "../opt/rte/", "<?php echo $sCSSURL?>", true);
//-->
</script>
<style type="text/css">
<!--
  ...
  <tr>
    <td valign="top"><?php if (!$bDidSave) { ?>
      ...
      <table border="0" cellspacing="0" cellpadding="6" style="height: 95%; width: 100%;">
        <tr>
          <td align="left" valign="top" class="rteField"><script language="JavaScript">
