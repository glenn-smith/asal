...
<p>--&gt; <a href="program/help/portuguese/activate.php" target="help" onclick="MM_openBrWindow('program/help/portuguese/activate.php','help','toolbar=yes,location=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=700,height=450'); return false">How do I activate WebYep?</a></p>
<?php } else { ?>
