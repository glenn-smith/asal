...
a.new:hover {
	...
	<body class="photo-background">
		...
		<div class="photo-navigation">
			...
			<p class="photo-links"><a href="../familyphotos.php">family photos</a> | <a href="page2-1043-full.php">Previous</a> | <a href="page2-1045-full.php">Next</a></p>
		</div>
		
		<img class="photo-frame" src="page2-1044-full.jpg" alt="Loading Image" width="360" height="480"/>
