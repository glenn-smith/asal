...
a.new:hover {
	...
	<body class="photo-background">
		...
		<div class="photo-navigation">
			...
			<p class="photo-links"><a href="../familyphotos.php">family photos</a> | <a href="page2-1003-full.php">Previous</a> | <a href="page2-1005-full.php">Next</a></p>
		</div>
		
		<img class="photo-frame" src="page2-1004-full.jpg" alt="Loading Image" width="640" height="359"/>
