...
$query_rs_cats = "SELECT * FROM animals WHERE status = 'available' AND animal_type='cat' ORDER BY animals.name ASC";
...
<title>ASAL Available Cats</title>
<!-- InstanceEndEditable -->
...
<div id="outerWrapper">
  ...
  <div id="contentWrapper">
    ...
    <div id="content"><!-- InstanceBeginEditable name="EditRegion3" -->
      <h1 align="center">Cats Available
      </h1>
      <h1>&nbsp;</h1>
      <hr />
      <div align="center">
        <?php do { ?>
          <table width="500" border="1">
            <tr>
              <td><img src="<?php echo $row_rs_cats['image_path']; ?>" alt="dogs pic" /></td>
              <td><p align="center"><?php echo $row_rs_cats['name']; ?> - <?php echo $row_rs_cats['birth_date']; ?><br />
                <?php echo $row_rs_cats['breed']; ?>-<?php echo $row_rs_cats['sex']; ?> <br />
                <?php echo $row_rs_cats['weight']; ?> lbs </p>
                <p><?php echo $row_rs_cats['description']; ?></p>
              <p><?php echo $row_rs_cats['adoptability']; ?></p></td>
            </tr>
          </table>
