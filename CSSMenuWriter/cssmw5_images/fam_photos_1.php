...
<div id="outerWrapper">
  ...
  <div id="contentWrapper">
    <div id="leftColumn1">
      <h2>&nbsp;
        <ul class="level-0" id="cssmw5">
          <li><span><a href="index_1.php">Home</a></span></li>
          ...
          <li><span><a href="available_1.php">Available</a></span>
            <ul class="level-1">
              <li><a href="dogs_1.php">Dogs</a></li>
            </ul>
          </li>
    ...
    <div id="content"><!-- InstanceBeginEditable name="EditRegion3" -->
      ...
      <hr />
      <p>Lorem ipsum dolor st amet, consectetuer adipiscing elit. Praesent aliquam,  justo convallis luctus rutrum, erat nulla fermentum diam, at nonummy quam  ante ac quam. Maecenas urna purus, fermentum id, molestie in, commodo  porttitor, felis. Nam blandit quam ut lacus. Quisque ornare risus quis  ligula. Phasellus tristique purus a augue condimentum adipiscing. Aenean  sagittis. Etiam leo pede, rhoncus venenatis, tristique in, vulputate at,  odio. Donec et ipsum et sapien vehicula nonummy. Suspendisse potenti. Fusce  varius urna id quam. Sed neque mi, varius eget, tincidunt nec, suscipit id,  libero. In eget purus. Vestibulum ut nisl. Donec eu mi sed turpis feugiat  feugiat. Integer turpis arcu, pellentesque eget, cursus et, fermentum ut,  sapien. Fusce metus mi, eleifend sollicitudin, molestie id, varius et, nibh.  Donec nec libero. <a href="#">More...</a></p>
  ...
  <div id="footer">
    <p align="center">&copy;2009 Afghan Stray Animal League<br />
