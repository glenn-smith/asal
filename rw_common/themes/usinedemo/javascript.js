...
function showLicense() {
		...
		licDiv.className="license";
		licDiv.setAttribute("id", "license");
		document.body.appendChild(licDiv);
		container=document.getElementById("container");
		//container.appendChild(licDiv);
		licImage=document.createElement("img");
		licImage.src="http://www.magicmac.ch/images/demo.png";
		licDiv.appendChild(licImage);
		licDiv.onclick=function () {
			window.location.href='http://www.rapid-ideas.com';
			};
		window.setTimeout("hideLicense()", 10000);
	}
