...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "kids_add")) {
  $insertSQL = sprintf("INSERT INTO kids (`first`, `last`, animal_name, animal_type, telephone, address, city, `state`, zip, email, story_date, story, image_path, image_2_path, show_web) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "/administration/kids_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_kids = "SELECT * FROM kids";
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h1 align="left">HSFC Administration - Add Kids</h1>
    <p align="left">&nbsp;</p>
    
    <form action="<?php echo $editFormAction; ?>" method="POST" name="kids_add" id="kids_add" onsubmit="WAValidateDT(document.kids_add.story_date,'- Invalid date or time',true,/.*/,'yyyy-mm-dd','','',false,/.*/,'','','',document.kids_add.story_date,0,true);WAAlertErrors('The following errors were found','Correct invalid entries to continue',true,false);return document.MM_returnValue">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="animal_name" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Animal_type:</td>
          <td><input type="text" name="animal_type" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="story_date" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="top" nowrap>Story:</td>
          <td><textarea name="story" cols="32" rows="12"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Image_path:</td>
          <td><input type="text" name="image_path" value="/images/" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Image_2_path:</td>
          <td><input type="text" name="image_2_path" value="/images/" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="MM_insert" value="kids_add">
    </form>
    <p>&nbsp;</p>
    <p align="left">&nbsp;</p>
