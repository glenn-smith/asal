...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "kids_change")) {
  $updateSQL = sprintf("UPDATE kids SET `first`=%s, `last`=%s, animal_name=%s, animal_type=%s, telephone=%s, address=%s, city=%s, `state`=%s, zip=%s, email=%s, story_date=%s, story=%s, image_path=%s, image_2_path=%s, show_web=%s WHERE kids_id=%s",
                       ...
                       GetSQLValueString($_POST['kids_id'], "int"));

  mysql_select_db($database_JLS_conn, $JLS_conn);
  $Result1 = mysql_query($updateSQL, $JLS_conn) or die(mysql_error());

  $updateGoTo = "/administration/kids_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rs_kids = "-1";
if (isset($_GET['kids_id'])) {
  $colname_rs_kids = (get_magic_quotes_gpc()) ? $_GET['kids_id'] : addslashes($_GET['kids_id']);
}
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_kids = sprintf("SELECT * FROM kids WHERE kids_id = %s", GetSQLValueString($colname_rs_kids, "int"));
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h1 align="left">HSFC Administration - Kids Change </h1>
    <p align="center"><img src="<?php echo $row_rs_kids['image_path']; ?>" /></p>
    
    <form action="<?php echo $editFormAction; ?>" method="post" name="kids_change" id="kids_change" onsubmit="WAValidateDT(document.kids_change.story_date,'- Invalid date or time',true,/.*/,'yyyy-mm-dd','','',false,/.*/,'','','',document.kids_change.story_date,0,true);WAAlertErrors('The following errors were found','Correct invalid entries to continue',true,false);return document.MM_returnValue">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">Kids_id:</td>
          <td><?php echo $row_rs_kids['kids_id']; ?></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">First:</td>
          <td><input type="text" name="first" value="<?php echo $row_rs_kids['first']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Last:</td>
          <td><input type="text" name="last" value="<?php echo $row_rs_kids['last']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Animal_name:</td>
          <td><input type="text" name="animal_name" value="<?php echo $row_rs_kids['animal_name']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Animal_type:</td>
          <td><input type="text" name="animal_type" value="<?php echo $row_rs_kids['animal_type']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Telephone:</td>
          <td><input type="text" name="telephone" value="<?php echo $row_rs_kids['telephone']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Address:</td>
          <td><input type="text" name="address" value="<?php echo $row_rs_kids['address']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">City:</td>
          <td><input type="text" name="city" value="<?php echo $row_rs_kids['city']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">State:</td>
          <td><input type="text" name="state" value="<?php echo $row_rs_kids['state']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Zip:</td>
          <td><input type="text" name="zip" value="<?php echo $row_rs_kids['zip']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Email:</td>
          <td><input type="text" name="email" value="<?php echo $row_rs_kids['email']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Story_date:</td>
          <td><input type="text" name="story_date" value="<?php echo $row_rs_kids['story_date']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Story:</td>
          <td><textarea name="story" cols="32" rows="12"><?php echo $row_rs_kids['story']; ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Image_path:</td>
          <td><input type="text" name="image_path" value="<?php echo $row_rs_kids['image_path']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Image_2_path:</td>
          <td><input type="text" name="image_2_path" value="<?php echo $row_rs_kids['image_2_path']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Show_web:</td>
      ...
      <input type="hidden" name="MM_update" value="kids_change">
      <input type="hidden" name="kids_id" value="<?php echo $row_rs_kids['kids_id']; ?>">
    </form>
    <p>&nbsp;</p>
    <p align="left">&nbsp;</p>
