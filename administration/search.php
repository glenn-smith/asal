...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    ...
    <form id="search" name="search" method="post" action="/administration/search_results.php">
      Enter the rabies tag number?
        <input name="rabies_tag" type="text" id="rabies_tag" />
    </form>
    <p align="left">&nbsp;</p>
    <p align="left">&nbsp;</p>
