...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "success_add")) {
  $insertSQL = sprintf("INSERT INTO success (`first`, `last`, animal_name, animal_type, telephone, address, city, `state`, zip, email, story_date, story, image_path, image_2_path, show_web) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "/administration/success_stories.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_ASAL, $ASAL);
$query_rs_success = "SELECT * FROM success";
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="success_add" id="success_add" onsubmit="WAValidateDT(document.success_add.story_date,'- Invalid date or time',true,/.*/,'yyyy-mm-dd','','',false,/.*/,'','','',document.success_add.story_date,0,true);WAAlertErrors('The following errors were found','Correct invalid entries to continue',true,false);return document.MM_returnValue">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input name="animal_name" type="text" id="animal_name" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="story_date" value="" size="15"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="MM_insert" value="success_add">
    </form>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="left">&nbsp;</p>
