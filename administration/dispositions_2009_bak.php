...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_foster_cats_adopt = "SELECT animals.animal_type, animals.adopt_date, animals.location, animals.name, animals.status FROM animals WHERE animals.animal_type='cat' AND animals.adopt_date>20081231 AND animals.adopt_date<20100101 AND animals.location='HSFC Foster' AND status='Adopted'";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_cats_fairfax = "SELECT animals.animal_type, animals.adopt_date, animals.location FROM animals WHERE animals.animal_type='cat' AND animals.adopt_date>20081231 AND animals.adopt_date<20100101 AND animals.location='HSFC Fairfax'";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_foster_intake = "SELECT * FROM animals WHERE animals.animal_type='cat' AND animals.intake_date>'2008-12-31' AND animals.intake_date<'2010-01-01' AND animals.location='HSFC Foster'";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_cats_bldg_intake = "SELECT * FROM animals WHERE animals.animal_type='cat' AND animals.intake_date>'2008-12-31' AND animals.intake_date<'2010-01-01' AND animals.location='HSFC Fairfax '";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_foster_euth = "SELECT * FROM animals WHERE animals.animal_type='cat' AND status = 'Euthanized' AND death_date>'2008-12-31' AND death_date<'2010-01-01' AND location='HSFC Foster'";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_foster_died = "SELECT * FROM animals WHERE animals.animal_type ='cat' AND animals.death_date>'2008-12-31' AND animals.death_date>'2010-01-01' AND animals.status='Died' AND animals.location='HSFC Foster'";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_euthanized = "SELECT * FROM animals WHERE status = 'Euthanized' AND death_date>2008-12-31 OR death_date<2010-01-01 ORDER BY animals.animal_type, animals.name";
...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_died = "SELECT * FROM animals WHERE animals.death_date>'2008-12-31' OR animals.death_date>'2008-01-01' AND animals.status='Died' ORDER BY animals.animal_type, animals.name";
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h2 align="center">HSFC Administration - Dispositions (2009)
