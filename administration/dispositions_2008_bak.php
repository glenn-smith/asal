...
mysql_select_db($database_JLS_conn, $JLS_conn);
$query_rs_euthanized = "SELECT * FROM animals WHERE status = 'Euthanized' AND death_date>2007-01-01 OR death_date<2009-01-01 ORDER BY animals.animal_type, animals.name";
