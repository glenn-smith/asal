...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adopter")) {
  $updateSQL = sprintf("UPDATE adopters SET animal_id=%s, animal_nu_name=%s, `first`=%s, `last`=%s, telephone=%s, tele_cell=%s, tele_work=%s, address1=%s, address2=%s, city=%s, `state`=%s, zip=%s, email=%s, adoption_date=%s, adoption_fee=%s WHERE adopter_id=%s",
                       ...
                       GetSQLValueString($_POST['adoption_fee'], "int"),
...
$colname_rs_adopters = "-1";
if (isset($_GET['adopter_id'])) {
  $colname_rs_adopters = (get_magic_quotes_gpc()) ? $_GET['adopter_id'] : addslashes($_GET['adopter_id']);
}
mysql_select_db($database_ASAL, $ASAL);
$query_rs_adopters = sprintf("SELECT * FROM adopters WHERE adopter_id = %s", $colname_rs_adopters);
...
<title>ASAL Adopter Change</title>
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h1 align="left">ASAL Administration - Adopter Change </h1>
    <p align="left">&nbsp;</p>
    
    <form action="<?php echo $editFormAction; ?>" method="POST" name="adopter" id="adopter" onsubmit="WAValidateDT(document.adopter.adoption_date,'- Invalid date or time',true,/.*/,'yyyy-mm-dd','','',false,/.*/,'','','',document.adopter.adoption_date,0,true);WAAlertErrors('The following errors were found','Correct invalid entries to continue',true,false);return document.MM_returnValue">
      <table align="center">
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input name="animal_id" type="text" id="animal_id" value="<?php echo $row_rs_adopters['animal_id']; ?>" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Animal_nu_name:</td>
          <td><input type="text" name="animal_nu_name" value="<?php echo $row_rs_adopters['animal_nu_name']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">First:</td>
          <td><input type="text" name="first" value="<?php echo $row_rs_adopters['first']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Last:</td>
          <td><input type="text" name="last" value="<?php echo $row_rs_adopters['last']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Home Tele:</td>
          <td><input type="text" name="telephone" value="<?php echo $row_rs_adopters['telephone']; ?>" size="24"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Work Tele:</td>
          <td><input name="tele_work" type="text" id="tele_work" value="<?php echo $row_rs_adopters['tele_work']; ?>" size="24" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Cell Tele:</td>
          <td name="tele_cell"><input name="tele_cell" type="text" id="tele_cell" value="<?php echo $row_rs_adopters['tele_cell']; ?>" size="24" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Address1:</td>
          <td><input type="text" name="address1" value="<?php echo $row_rs_adopters['address1']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Address2:</td>
          <td><input type="text" name="address2" value="<?php echo $row_rs_adopters['address2']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">City:</td>
          <td><input type="text" name="city" value="<?php echo $row_rs_adopters['city']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">State:</td>
          <td><input type="text" name="state" value="<?php echo $row_rs_adopters['state']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Zip:</td>
          <td><input type="text" name="zip" value="<?php echo $row_rs_adopters['zip']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Email:</td>
          <td><input type="text" name="email" value="<?php echo $row_rs_adopters['email']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Adoption_date:</td>
          <td><input type="text" name="adoption_date" value="<?php echo $row_rs_adopters['adoption_date']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Adoption_fee:</td>
          <td><input type="text" name="adoption_fee" value="<?php echo $row_rs_adopters['adoption_fee']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="adopter_id" value="<?php echo $row_rs_adopters['adopter_id']; ?>">
      <input type="hidden" name="MM_update" value="adopter">
    </form>
    <p>&nbsp;</p>
    <p align="left">&nbsp;</p>
