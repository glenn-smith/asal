...
$query_rs_success = "SELECT * FROM success ORDER BY story_date DESC";
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    ...
    <table width="520" border="5">
      <tr>
        ...
        <th scope="col"><p>Show Web </p>        </th>
        <th scope="col">Image</th>
        <th scope="col">Animal Name </th>
      </tr>
      <?php do { ?>
        <tr>
          <td><a href="/administration/success_change.php?success_id=<?php echo $row_rs_success['success_id']; ?>"><?php echo $row_rs_success['first']; ?></a></td>
          <td><?php echo $row_rs_success['last']; ?></td>
          <td><?php echo $row_rs_success['story_date']; ?></td>
          <td><?php echo $row_rs_success['show_web']; ?></td>
          <td><?php echo $row_rs_success['image_path']; ?></td>
          <td><?php echo $row_rs_success['animal_name']; ?></td>
        </tr>
