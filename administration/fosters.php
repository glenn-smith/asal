...
$query_rs_foster_list = "SELECT * FROM foster ORDER BY `last` ASC";
$rs_foster_list = mysql_query($query_rs_foster_list, $ASAL) or die(mysql_error());
$row_rs_foster_list = mysql_fetch_assoc($rs_foster_list);
$totalRows_rs_foster_list = mysql_num_rows($rs_foster_list);
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h1 align="left">HSFC Administration - Fosters List</h1>
    <table width="520" border="5">
      <tr>
        <th scope="col">First</th>
        <th scope="col">Last</th>
        <th scope="col">ID</th>
        <th scope="col">Home<br />
        Tele</th>
        <th scope="col">Cell<br />
          Tele</th>
      ...
      <?php do { ?>
        <tr>
          <td><?php echo $row_rs_foster_list['first']; ?></td>
          <td><a href="foster_edit.php?foster_id=<?php echo $row_rs_foster_list['foster_id']; ?>"><?php echo $row_rs_foster_list['last']; ?></a></td>
          <td><?php echo $row_rs_foster_list['foster_id']; ?></td>
          <td><?php echo $row_rs_foster_list['home_phone']; ?></td>
          <td><?php echo $row_rs_foster_list['cell_phone']; ?></td>
          <td><?php echo $row_rs_foster_list['email']; ?></td>
          <td>&nbsp;</td>
        </tr>
        <?php } while ($row_rs_foster_list = mysql_fetch_assoc($rs_foster_list)); ?>
    </table>
    <p align="left"><br />
      Total Fosters - <?php echo $totalRows_rs_foster_list ?> </p>
    <p align="left">&nbsp;</p>
    <p align="left">&nbsp;</p>
