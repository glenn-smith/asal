...
if (isset($_POST['user_id'])) {
  ...
  $MM_redirectLoginSuccess = "animal_inventory.php";
  $MM_redirectLoginFailed = "log_in_fails.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_JLS_conn, $JLS_conn);
  
  $LoginRS__query=sprintf("SELECT user_id, user_pwd FROM `admin` WHERE user_id=%s AND user_pwd=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $JLS_conn) or die(mysql_error());
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    <h1 mmdw="33"  align="left">HSFC Administration </h1>
    <h1 mmdw="34"  align="center">Log-In</h1>
    <form mmdw="35"  ACTION="<?php echo $loginFormAction; ?>" id="log_in" name="log_in" method="POST">
      <div mmdw="36"  align="left">
        <p mmdw="37"  align="center">User_ID:
          <input mmdw="38"  name="user_id" type="text" id="user_id" />
        </p>
        <p mmdw="39"  align="center">Password:
          <input mmdw="40"  name="user_pwd" type="password" id="user_pwd" />
        </p>
        <p mmdw="41"  align="center">
          <input mmdw="42"  type="submit" name="Submit" value="Submit" />
        </p>
      </div>
    </form>
    <p mmdw="43"  align="center">&nbsp;</p>
    <p mmdw="44"  align="left">&nbsp;</p>
