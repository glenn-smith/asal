...
$query_rs_animals = "SELECT * FROM animals ORDER BY animal_type ASC, animals.name";
...
<title>ASAL Animal Inventory</title>
...
<div id="holder">
  ...
  <div id="content_nav"><!-- InstanceBeginEditable name="content" -->
    ...
    <table width="550" border="5">
      <caption align="top">
        <strong>Animal Inventory</strong>
      </caption>
      <tr>
      ...
      <?php do { ?>
        <tr>
          <td><p><?php echo $row_rs_animals['animal_type']; ?></p></td>
          <td><p><?php echo $row_rs_animals['status']; ?></p></td>
          <td><?php echo $row_rs_animals['animal_id']; ?></td>
          <td><p><a href="animal_change.php?animal_id=<?php echo $row_rs_animals['animal_id']; ?>"><?php echo $row_rs_animals['name']; ?></a></p></td>
          <td><p><?php echo $row_rs_animals['location']; ?></p></td>
          <td><p><?php echo $row_rs_animals['sex']; ?></p></td>
        </tr>
        <?php } while ($row_rs_animals = mysql_fetch_assoc($rs_animals)); ?>
    </table>
    <p align="center"><a href="log_in.php">&nbsp;Log out</a><a href="<?php echo $logoutAction ?>"></a></p>
    <p align="left">&nbsp;</p>
