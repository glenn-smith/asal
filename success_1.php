...
$query_rs_success = "SELECT * FROM success WHERE show_web = 'yes' ORDER BY story_date DESC";
...
<title>ASAL Success Stories</title>
<!-- InstanceEndEditable -->
...
<div id="outerWrapper">
  ...
  <div id="contentWrapper">
    ...
    <div id="content"><!-- InstanceBeginEditable name="EditRegion3" -->
      <h1 align="center">Success Stories
      </h1>
      <p align="center">&nbsp;</p>
      <?php do { ?>
        <table width="500" border="1">
          <tr>
            <th colspan="2" bgcolor="#904841" scope="col"><div align="center"></div></th>
          </tr>
          <tr>
            <td><h2 align="center"><img src="<?php echo $row_rs_success['image_path']; ?>" width="240" /></h2></td>
            <td><div align="center"><img src="<?php echo $row_rs_success['image_2_path']; ?>" width="240" /></div></td>
          </tr>
          <tr>
            <td><div align="center">Tigger House</div></td>
            <td><div align="center">ForEver Home</div></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo $row_rs_success['story']; ?></td>
          </tr>
        </table>
